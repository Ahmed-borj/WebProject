  ...
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_left">
      <ul class="nospace">
        ...
        <li><a href="/pages/modifierC.php">About</a></li>
        <li><a href="#">Contact</a></li>
        <?php if (!isset($_SESSION['client_id'])) { ?>
        <li><a href="/pages/loginC.php">Login</a></li>
    ...
    <div class="fl_right">
      <ul class="nospace">
        ...
        <li><a href="/pages/logout.php"><i class="fas fa-sign-out-alt rgtspace-5"></i>Déconnexion</li></a>
      </ul>
    </div>
    <?php } ?>
    <!-- ################################################################################################ -->
